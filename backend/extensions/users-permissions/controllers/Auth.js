//based on  https://github.com/strapi/strapi/blob/master/packages/strapi-plugin-users-permissions/controllers/Auth.js
//updated 03.03.2021
...
function SetServerCookie(ctx,token){
  ctx.cookies.set("token", token, {
      httpOnly: true,
      secure: process.env.NODE_ENV === "production",
      sameSite: 'strict',
      maxAge: 1000 * 60 * 60 * 24 * 3000, // make it valid for a long time (3000 days)
...
console.log(grantConfig[provider]);
  ...
  async forgotPassword(ctx) {
    ...
    try {
      ...
      console.log("fehler beim email versand",err);
